...
Veri akisi:
  ...
  → iCloud Drive/Auto Export/B.A.R.B.A.R.O.S/HealthAutoExport-YYYY-MM-DD.json
  → B.A.R.B.A.R.O.S
"""
...
HEALTH_DIR = _ICLOUD_BASE / "iCloud~com~ifunography~HealthExport" / "Documents" / "B.A.R.B.A.R.O.S"

# Geriye dönük uyumluluk — eski konumlar
_LEGACY_DIRS = [
    _ICLOUD_BASE / "Auto Export" / "B.A.R.B.A.R.O.S",
    _ICLOUD_BASE / "B.A.R.B.A.R.O.S",
    Path.home() / "OneDrive" / "B.A.R.B.A.R.O.S",
]

# Legacy düz dosya
_LEGACY_FILE = _ICLOUD_BASE / "B.A.R.B.A.R.O.S" / "health_data.json"
...
def get_health_data(query: str = "all") -> str:
    ...
    if not _resolve_file(target_date):
        return (
            ...
            "iCloud Drive > Auto Export > B.A.R.B.A.R.O.S klasörüne export ayarlaman gerekiyor."
        )
